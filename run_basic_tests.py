...
class BasicTestRunner:
    ...
    def run_all_basic_tests(self):
        ...
        for test_file in test_files:
            ...
            print(f"{status_icon} {test_file}: {result['status']} ({result['duration']}s)")
    ...
    def print_summary_report(self):
        ...
        print(f"📈 Coverage: {coverage['coverage_percentage']}% ({coverage['passed']}/{coverage['total_tests']} tests passed)")
        
        target_met = "✅" if coverage['meets_80_percent_target'] else "❌"
        print(f"{target_met} 80% Coverage Target: {'MET' if coverage['meets_80_percent_target'] else 'NOT MET'}")
