...
class Config:
    ...
    MAIL_ASCII_ATTACHMENTS = (
        os.getenv("MAIL_ASCII_ATTACHMENTS", "False").lower() == "true"
    )
    ...
    ALLOWED_EXTENSIONS = set(
        os.getenv("ALLOWED_EXTENSIONS", "txt,pdf,png,jpg,jpeg,gif").split(",")
    )
...
EMAIL_TEMPLATES = {
    "welcome": {"subject": "Welcome to {app_name}!", "template": "emails/welcome.html"},
    "password_reset": {
...
DATABASE_POOLS = {
    "development": {"pool_size": 5, "max_overflow": 10, "pool_timeout": 30},
    "production": {
        "pool_size": 20,
        "max_overflow": 30,
        "pool_timeout": 60,
    ...
    "testing": {"pool_size": 1, "max_overflow": 0, "pool_timeout": 10},
}
# OAuth Configuration
GOOGLE_CLIENT_ID = os.getenv("GOOGLE_CLIENT_ID")
GOOGLE_CLIENT_SECRET = os.getenv("GOOGLE_CLIENT_SECRET")
...
GOOGLE_INCLUDE_GRANTED_SCOPES = (
    os.getenv("GOOGLE_INCLUDE_GRANTED_SCOPES", "true").lower() == "true"
)
