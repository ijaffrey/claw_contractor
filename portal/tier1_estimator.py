...
def estimate_permit(permit: dict[str, Any], bucket: str) -> dict[str, Any] | None:
    ...
    return {
        ...
        "filing_rep": permit.get("filing_representative_business_name"),
        ...
        "applicant_title": permit.get("applicant_professional_title"),
        "filing_rep_first_name": permit.get("filing_representative_first_name"),
