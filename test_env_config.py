...
class TestConfig:
    ...
    # Test data
    TEST_CONTRACTORS = [
        ('John Smith Plumbing', 'john@smithplumbing.com', '555-0101', 'plumbing,emergency repairs', 1),
        ('ABC Electrical', 'info@abcelectrical.com', '555-0102', 'electrical,wiring', 1),
        ('Perfect HVAC', 'service@perfecthvac.com', '555-0103', 'hvac,heating,cooling', 1)
    ]
