        ...
        'conversation_flow': [
            {
                ...
                'ai_should': ['Match detail-oriented tone', 'Acknowledge observations', 'Ask ONE clarifying question'],
                'ai_must_not': ['Try to diagnose over email', 'Give DIY advice', 'Ask multiple technical questions']
            },
            {
                'step': 2,
                ...
                'ai_should': ['Note troubleshooting attempts', 'Move toward scheduling', 'Brief response'],
                'ai_must_not': ['Continue technical diagnosis', 'Lecture about temperature settings']
            },
            {
                'step': 3,
        ...
        'conversation_flow': [
            {
                ...
                'ai_should': ['Stay VERY calm', 'Validate they stopped using water', 'Be brief', 'ONE question max'],
                'ai_must_not': ['Match panic tone', 'Multiple questions', 'Give DIY instructions']
            },
            {
                'step': 2,
                ...
                'ai_should': ['Acknowledge severity', 'Collect address/availability', 'Calm confidence'],
                'ai_must_not': ['Promise specific time without checking', 'Diagnose the issue']
            },
            {
                'step': 3,
                'homeowner_reply': "4523 Maple Ridge Drive, 78731. We're here all day, sooner the better obviously! What's this gonna cost?",
                'ai_should': ['Focus on getting there', 'No pricing in emergency', 'Brief reassurance'],
                'ai_must_not': ['Give pricing estimates', 'Slow down with explanations']
            },
            {
                'step': 4,
                'homeowner_reply': "OK fine just get here please. Back door is easier to access that bathroom.",
                'ai_should': ['Note access detail', 'Confirm arrival plan', 'Keep very brief'],
        ...
        'conversation_flow': [
            {
                ...
                'ai_should': ['Match friendly casual tone', 'Acknowledge the mistake lightly', 'Ask ONE thing'],
                'ai_must_not': ['Lecture about winterizing', 'Be overly formal', 'Multiple questions']
            },
            {
                'step': 2,
                ...
                'ai_should': ['Simple reassurance', 'Move toward scheduling', 'Keep conversational'],
                'ai_must_not': ['Get technical about freeze damage', 'Create unnecessary alarm']
            },
            {
                'step': 3,
        ...
        'conversation_flow': [
            {
                ...
                'ai_should': ['Acknowledge DIY attempts positively', 'Respect budget concerns', 'Don\'t quote price'],
                'ai_must_not': ['Give pricing over email', 'Try to diagnose what\'s stuck', 'Upsell replacement']
            },
            {
                'step': 2,
                ...
                'ai_should': ['Redirect gently without pricing', 'Acknowledge the question', 'Short response'],
                'ai_must_not': ['Give specific pricing', 'Make them feel bad for asking']
            },
            {
                'step': 3,
        ...
        'conversation_flow': [
            {
                ...
                'ai_should': ['Acknowledge systematic approach', 'Match organized tone', 'ONE question'],
                'ai_must_not': ['Try to diagnose valve issue', 'Ask multiple questions', 'Get technical']
            },
            {
                'step': 2,
                ...
                'ai_should': ['Note the details', 'Move toward scheduling', 'Professional tone'],
            ...
            },
            {
                ...
                'ai_should': ['Address access question simply', 'Confirm scheduling options'],
                'ai_must_not': ['Over-explain the repair process', 'Promise specific approach']
            },
            {
                'step': 4,
        ...
        'conversation_flow': [
            {
                ...
                'ai_should': ['Stay calm and reassuring', 'Validate checks they did', 'Brief response'],
                'ai_must_not': ['Match anxious tone', 'Give DIY repair instructions', 'Multiple questions']
            },
            {
                'step': 2,
                ...
                'ai_should': ['Simple protective advice if any', 'Address availability directly', 'Calming confidence'],
                'ai_must_not': ['Create more worry', 'Promise specific ETA without checking']
            },
            {
                'step': 3,
                ...
                'ai_should': ['Focus on getting there first', 'Brief response', 'Don\'t commit to solution'],
                'ai_must_not': ['Promise to fix vs replace', 'Talk pricing during emergency']
            },
            {
                'step': 4,
        ...
        'conversation_flow': [
            {
                ...
                'ai_should': ['Acknowledge insurance question', 'Don\'t give insurance advice', 'Professional tone'],
                'ai_must_not': ['Promise insurance will cover it', 'Give detailed insurance process', 'Commit to specific documentation format']
            },
            {
                'step': 2,
                ...
                'ai_should': ['Address inspection fee policy clearly', 'No timeline commitments', 'Stay professional'],
                'ai_must_not': ['Give pricing details for repairs', 'Promise claim timeline']
            },
            {
                'step': 3,
                ...
                'ai_should': ['Outline any needed info simply', 'Professional scheduling'],
        ...
        'conversation_flow': [
            {
                ...
                'ai_should': ['Acknowledge technical knowledge', 'Don\'t get into technical back-and-forth', 'Professional tone'],
                'ai_must_not': ['Try to diagnose solution', 'Get into technical debate', 'Recommend specific approach']
            },
            {
                'step': 2,
                ...
                'ai_should': ['Redirect to assessment first', 'Don\'t commit to approach', 'Professional'],
                'ai_must_not': ['Give technical recommendation', 'Promise portfolio via email']
            },
            {
                'step': 3,
        ...
        'conversation_flow': [
            {
                ...
                'ai_should': ['Stay calm and reassuring', 'Don\'t create panic', 'Address safety simply'],
                'ai_must_not': ['Match panicked tone', 'Give DIY ice removal advice', 'Overstate danger']
            },
            {
                'step': 2,
                ...
                'ai_should': ['Advise against DIY if dangerous', 'Brief safety guidance', 'Focus on getting there'],
                'ai_must_not': ['Give detailed ice removal instructions', 'Multiple questions']
            },
            {
                'step': 3,
                ...
                'ai_should': ['Brief answer about approach', 'Don\'t over-explain', 'Confirm details'],
                'ai_must_not': ['Get technical about ice dam removal', 'Promise specific method']
            },
            {
                'step': 4,
        ...
        'conversation_flow': [
            {
                ...
                'ai_should': ['Match courteous, slower pace', 'Patient tone', 'ONE question'],
            ...
            },
            {
                ...
                'ai_should': ['Accommodate their schedule', 'Respectful tone', 'Clear about timing'],
                'ai_must_not': ['Be pushy about scheduling', 'Suggest inconvenient times']
            },
            {
                'step': 3,
        ...
        'conversation_flow': [
            {
                ...
                'ai_should': ['Match direct, brief style', 'ONE question max', 'Very short'],
                'ai_must_not': ['Send long response', 'Ask multiple questions', 'Over-explain']
            },
            {
                'step': 2,
                'homeowner_reply': "245 E 78th St Apt 5C. Weekday mornings before 9am or after 7pm. Weekend mornings. Need it done this week.",
                'ai_should': ['Acknowledge timeline pressure', 'Confirm if possible', 'Stay brief'],
            ...
            },
            {
                ...
                'ai_must_not': ['Give pricing estimate', 'Get defensive about don\'t be late']
            },
            {
                'step': 4,
        ...
        'conversation_flow': [
            {
                ...
                'ai_should': ['Acknowledge other quotes', 'Don\'t give pricing', 'Respect shopping process'],
                'ai_must_not': ['Quote pricing without seeing it', 'Badmouth competitor pricing', 'Pressure them']
            },
            {
                'step': 2,
                ...
                'ai_should': ['Clear on estimate policy', 'Don\'t become their consultant', 'Professional'],
                'ai_must_not': ['Give lengthy advice on vetting contractors', 'Multiple questions']
            },
            {
                'step': 3,
                ...
                'ai_should': ['Typical estimate timeframe', 'Confirm scheduling', 'Professional'],
        ...
        'conversation_flow': [
            {
                ...
                'ai_should': ['Acknowledge technical knowledge', 'Don\'t quote pricing', 'Professional tone'],
                'ai_must_not': ['Get into detailed technical discussion', 'Recommend specific panel size', 'Give pricing']
            },
            {
                'step': 2,
                ...
                'ai_should': ['Acknowledge solar planning', 'Don\'t commit to specific approach', 'Defer details to assessment'],
                'ai_must_not': ['Design the system via email', 'Promise specific solar prep work']
            },
            {
                'step': 3,
                ...
                'ai_should': ['Typical assessment time', 'Move to scheduling', 'Professional'],
            ...
            },
            {
                ...
                'ai_must_not': ['Promise specific quote format without knowing HOA requirements']
            },
            {
                'step': 6,
        ...
        'conversation_flow': [
            {
                ...
                'ai_should': ['Very patient and clear', 'Reassuring tone', 'Simple guidance'],
                'ai_must_not': ['Use technical terms', 'Ask multiple questions', 'Rush them']
            },
            {
                'step': 2,
                ...
                'ai_should': ['Acknowledge concern', 'Address availability clearly', 'Warm and patient'],
                'ai_must_not': ['Use jargon like GFCI or circuit', 'Make them feel foolish']
            },
            {
                'step': 3,
                ...
                'ai_should': ['Simple guidance on access', 'Clear about arrival', 'Patient'],
            ...
            },
            {
                ...
                'ai_should': ['Clear about timing', 'Reassure about power', 'Simple explanation'],
                'ai_must_not': ['Be vague about timing', 'Over-explain the repair process']
            },
            {
                'step': 5,
        ...
        'conversation_flow': [
            {
                ...
                'ai_should': ['Acknowledge safety concern', 'Don\'t give detailed code requirements', 'Professional'],
                'ai_must_not': ['Give specific code requirements', 'Quote detector quantities', 'Technical details']
            },
            {
                'step': 2,
                ...
                'ai_should': ['Honest about scope', 'No specific commitments', 'Understanding tone'],
                'ai_must_not': ['Promise no wall cutting', 'Get too technical about wiring paths']
            },
            {
                'step': 3,
                ...
                'ai_should': ['Acknowledge timeline concern', 'Move to scheduling', 'Professional and warm'],
        ...
        'conversation_flow': [
            {
                ...
                'ai_should': ['Sympathetic to DIY attempt', 'Don\'t diagnose wiring', 'Light and friendly'],
                'ai_must_not': ['Give wiring instructions', 'Lecture about DIY electrical', 'Make them feel stupid']
            },
            {
                'step': 2,
                ...
                'ai_must_not': ['Say I told you so', 'Give pricing', 'Be condescending']
            },
            {
                'step': 3,
        ...
        'conversation_flow': [
            {
                ...
                'ai_should': ['Acknowledge contractor coordination', 'Professional tone', 'Clear about coordination'],
                'ai_must_not': ['Overcomplicate the staging', 'Promise specific timeline']
            },
            {
                'step': 2,
                ...
                'ai_should': ['Clarify coordination preference', 'Professional', 'ONE question'],
            ...
            },
            {
                ...
                'ai_should': ['Address quote timing', 'Note permit requirement', 'Professional'],
                'ai_must_not': ['Give quote without seeing scope', 'Promise instant quote']
            },
            {
                'step': 4,
            ...
            },
            {
                ...
                'ai_should': ['Note both contacts', 'Confirm appointment', 'Professional'],
                'ai_must_not': ['Over-communicate']
            }
        ]
    },
        ...
        'conversation_flow': [
            {
                ...
                'ai_should': ['Acknowledge security concern', 'Don\'t recommend specific quantities', 'Professional'],
                'ai_must_not': ['Design the system via email', 'Recommend specific products']
            },
            {
                'step': 2,
                ...
                'ai_should': ['Move to scheduling', 'General timeline if typical', 'Professional'],
                'ai_must_not': ['Promise specific timeline', 'Get into technical installation details']
            },
            {
                'step': 3,
            ...
            },
            {
                ...
                'ai_should': ['Brief response on smart systems', 'Don\'t commit to specific brands'],
        ...
        'conversation_flow': [
            {
                ...
                'ai_should': ['Acknowledge waterproofing priority', 'Don\'t give specific sequencing yet', 'Professional'],
                'ai_must_not': ['Recommend specific waterproofing approach', 'Commit to project sequence']
            },
            {
                'step': 2,
                ...
                'ai_should': ['Clarify trade coverage', 'Ask for photos or site visit', 'Professional'],
            ...
            },
            {
                ...
                'ai_should': ['Acknowledge budget question without committing', 'No timeline commitment', 'Need site visit'],
                'ai_must_not': ['Validate or reject their budget', 'Give project timeline']
            },
            {
                'step': 4,
                ...
                'ai_should': ['Helpful guidance on preparation', 'Move to scheduling', 'Organized tone'],
            ...
            },
            {
                ...
                'ai_should': ['Clear about estimate process and timing', 'Confirm appointment'],
        ...
        'conversation_flow': [
            {
                ...
                'ai_should': ['Patient tone', 'Don\'t give pricing', 'Don\'t push them to decide'],
                'ai_must_not': ['Give specific pricing comparison', 'Recommend one over the other', 'Show impatience']
            },
            {
                'step': 2,
                ...
                'ai_should': ['Acknowledge questions', 'Redirect to site visit', 'Patient'],
                'ai_must_not': ['Recommend specific brands', 'Get into detailed material comparison', 'Rush them']
            },
            {
                'step': 3,
                ...
                'ai_should': ['Willing to show examples', 'Move to scheduling', 'Helpful tone'],
            ...
            },
            {
                ...
                'ai_should': ['Encourage both homeowners present', 'Confirm scheduling', 'Friendly'],
        ...
        'conversation_flow': [
            {
                ...
                'ai_should': ['Don\'t commit to timeline', 'Match directness', 'Professional'],
                'ai_must_not': ['Promise 4-week timeline', 'Be overly cautious about timeline']
            },
            {
                'step': 2,
                ...
                'ai_should': ['Match urgency in scheduling', 'Clear about quote timing', 'Professional'],
                'ai_must_not': ['Slow them down unnecessarily', 'Promise instant quote']
            },
            {
                'step': 3,
                ...
                'ai_should': ['Address portfolio request', 'Confirm appointment', 'Brief'],
            ...
            },
            {
                ...
                'ai_should': ['Confident but realistic', 'Don\'t over-promise', 'Professional'],
                'ai_must_not': ['Say anything that sounds like excuse-making', 'Guarantee no delays']
            },
            {
                'step': 5,
        ...
        'conversation_flow': [
            {
                ...
                'ai_should': ['Acknowledge planning', 'Don\'t get into electrical technical details', 'Professional'],
                'ai_must_not': ['Recommend specific cabinet sources', 'Diagnose electrical complexity']
            },
            {
                'step': 2,
                ...
                'ai_should': ['Clarify what\'s included in scope', 'Professional', 'Ask to see plans'],
                'ai_must_not': ['Commit to specific scope without seeing it', 'Give pricing']
            },
            {
                'step': 3,
                ...
                'ai_should': ['Helpful on what to prepare', 'Scheduling', 'Organized tone'],
            ...
            },
            {
                ...
                'ai_should': ['Acknowledge budget without committing', 'Need to see scope first'],
        ...
        'conversation_flow': [
            {
                ...
                'ai_should': ['Compassionate and patient', 'Don\'t recommend specific solution', 'Respectful'],
                'ai_must_not': ['Get technical about accessibility codes', 'Rush them', 'Recommend without seeing it']
            },
            {
                'step': 2,
                ...
                'ai_should': ['Acknowledge needs', 'Don\'t give product recommendations', 'Patient'],
            ...
            },
            {
                ...
                'ai_should': ['Accommodate their schedule', 'Respectful and patient', 'Clear timing'],
        ...
        'conversation_flow': [
            {
                ...
                'ai_should': ['Clarify insurance process', 'Professional', 'Don\'t over-commit on process'],
                'ai_must_not': ['Promise to match insurance estimate', 'Give insurance billing advice']
            },
            {
                'step': 2,
                ...
                'ai_must_not': ['Promise to meet their deadline', 'Rush the assessment']
            },
            {
                'step': 3,
            ...
            },
            {
                ...
                'ai_should': ['Simple guidance on paint selection', 'Confirm appointment'],
        ...
        'conversation_flow': [
            {
                ...
                'ai_should': ['Acknowledge complex requirements', 'Don\'t commit to specific scope', 'Professional'],
                'ai_must_not': ['Try to scope entire project via email', 'Give technical advice', 'Quote pricing']
            },
            {
                'step': 2,
                ...
                'ai_should': ['Acknowledge phasing', 'Don\'t give HVAC advice', 'Redirect to assessment'],
                'ai_must_not': ['Design the HVAC system', 'Recommend specific approach']
            },
            {
                'step': 3,
                ...
                'ai_should': ['No timeline commitment', 'Honest about complexity', 'Professional'],
                'ai_must_not': ['Commit to 4-6 week timeline', 'Dismiss their concerns']
            },
            {
                'step': 4,
            ...
            },
            {
                ...
                'ai_should': ['Acknowledge budget without committing', 'Need assessment first'],
        ...
        'conversation_flow': [
            {
                ...
                'ai_should': ['Acknowledge DIY paint supply', 'Don\'t quote pricing', 'Professional'],
                'ai_must_not': ['Give per sq ft pricing', 'Commit to their budget', 'Discourage them from buying paint']
            },
            {
                'step': 2,
                ...
                'ai_should': ['Respect budget concern', 'Don\'t quote pricing', 'Redirect to assessment'],
                'ai_must_not': ['Compare to other quote', 'Give range', 'Make them feel bad for asking']
            },
            {
                'step': 3,
                ...
                'ai_should': ['Move to scheduling', 'Typical walkthrough time', 'Professional'],
                'ai_must_not': ['Continue pricing discussion']
            },
            {
                'step': 4,
