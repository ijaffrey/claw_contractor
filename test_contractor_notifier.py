...
class TestContractorLookup(unittest.TestCase):
    ...
    def test_find_contractors_sorted_by_rating(self):
        ...
        self.assertEqual(contractors[0]['name'], "Mike's Plumbing")  # Higher rating first
...
class TestContractorNotifier(unittest.TestCase):
    ...
    def test_notify_contractors_success(self):
        ...
        self.mock_contractor_lookup.find_contractors.return_value = self.sample_contractors
        ...
        # Verify method calls
        self.mock_contractor_lookup.find_contractors.assert_called_once_with('Plumbing', '12345')
    ...
    def test_notify_contractors_email_generation_failure(self):
        self.mock_contractor_lookup.extract_zip_code.return_value = '12345'
        self.mock_contractor_lookup.find_contractors.return_value = self.sample_contractors
        self.mock_email_generator.generate_subject_line.side_effect = Exception("Template error")
    ...
    def test_notify_contractors_rate_limiting(self):
        ...
        with patch('time.sleep') as mock_sleep:
            result = self.notifier.notify_contractors(self.sample_lead, max_contractors=5)
            ...
            self.assertTrue(mock_sleep.call_count >= 4)  # At least 4 delays between 5 emails
    ...
    def test_notify_single_contractor_success(self):
        ...
        result = self.notifier.notify_single_contractor(self.sample_lead, contractor['id'])
        
        self.assertTrue(result['success'])
        self.assertIsNone(result.get('error'))
        
    def test_notify_single_contractor_not_found(self):
        self.mock_contractor_lookup.get_contractor_by_id.side_effect = ContractorNotFoundError("Not found")
...
class TestTemplateRendering(unittest.TestCase):
    ...
    def test_template_special_characters(self):
        ...
        content = self.generator.generate_email_content(
            lead,
            contractor_name="Mike's Plumbing & Repair",
            format_type='html'
        )
