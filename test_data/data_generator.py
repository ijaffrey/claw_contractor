...
class TestDataGenerator:
    ...
    def __init__(self, seed: int = None):
        ...
        self.contractor_types = [
            ...
            'Roofer', 'Flooring Specialist', 'Painter', 'Landscaper', 'Handyman'
        ]
        
        self.service_types = [
            'Kitchen Renovation', 'Bathroom Remodel', 'Plumbing Repair',
            'Electrical Work', 'Roofing', 'Flooring Installation',
            'Interior Painting', 'Landscaping', 'Home Repair'
        ]
        
        self.lead_sources = ['Google', 'Referral', 'Facebook', 'Website', 'Yelp']
        self.names = ['John Smith', 'Jane Doe', 'Mike Johnson', 'Sarah Wilson', 'David Brown']
    ...
    def generate_lead_data(self, count: int = 10) -> List[Dict[str, Any]]:
        ...
        for i in range(count):
            lead = {
                ...
                'budget_range': random.choice(['$1000-$5000', '$5000-$10000', '$10000-$20000', '$20000+']),
                'timeline': random.choice(['ASAP', '1-2 weeks', '1 month', '2-3 months']),
    ...
    def generate_email_data(self, count: int = 20) -> List[Dict[str, Any]]:
        ...
        for i in range(count):
            ...
            email = {
                ...
                'labels': ['INBOX', 'IMPORTANT'] if random.random() < 0.3 else ['INBOX'],
