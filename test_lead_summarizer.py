...
try:
    ...
    print(
        "✓ _build_summary_prompt method exists:", hasattr(ls, "_build_summary_prompt")
    )
    print(
        "✓ _calculate_lead_score method exists:", hasattr(ls, "_calculate_lead_score")
    )
    ...
    mock_messages = [
        {
            "from_customer": True,
            "content": "I need a contractor for my kitchen remodel",
        },
        {"from_customer": False, "content": "What is your budget for this project?"},
        {
            "from_customer": True,
            "content": "Around $15,000, and I need it done by next month",
        },
    ]
    ...
    mock_summary = {
        "raw_summary": "Customer needs urgent kitchen remodel, budget $15,000"
    }
