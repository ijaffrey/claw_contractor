...
class TestLoadConversationHistory:
    ...
    def test_load_conversation_history_valid_lead_id(
        self, conversation_manager, mock_db_manager, sample_conversation_messages
    ):
    ...
    def test_load_conversation_history_invalid_lead_id(
        self, conversation_manager, mock_db_manager
    ):
        """Test loading conversation history for invalid lead ID."""
        # Arrange
        invalid_lead_id = -1
        mock_db_manager.get_conversation_history.side_effect = ValueError(
            "Invalid lead ID"
        )
    ...
    def test_load_conversation_history_nonexistent_lead(
        self, conversation_manager, mock_db_manager
    ):
        ...
        # Assert
        assert result == []
        mock_db_manager.get_conversation_history.assert_called_once_with(
            nonexistent_lead_id
        )

    def test_load_conversation_history_empty_history(
        self, conversation_manager, mock_db_manager
    ):
    ...
    def test_load_conversation_history_chronological_ordering(
        self, conversation_manager, mock_db_manager
    ):
    ...
    def test_load_conversation_history_database_error(
        self, conversation_manager, mock_db_manager
    ):
        """Test handling database errors during conversation history loading."""
        # Arrange
        lead_id = 1
        mock_db_manager.get_conversation_history.side_effect = Exception(
...
class TestGetConversationContext:
    ...
    def test_get_conversation_context_with_history(
        self,
    ...
    def test_get_conversation_context_no_history(
        self, conversation_manager, mock_db_manager, sample_lead
    ):
    ...
    def test_get_conversation_context_with_qualification_steps(
        self, conversation_manager, mock_db_manager, sample_lead
    ):
    ...
    def test_get_conversation_context_invalid_lead(
        self, conversation_manager, mock_db_manager
    ):
    ...
    def test_get_conversation_context_with_metadata(
        self, conversation_manager, mock_db_manager, sample_lead
    ):
...
class TestUpdateThreadId:
    ...
    def test_update_thread_id_success(self, conversation_manager, mock_db_manager):
        ...
        mock_db_manager.update_thread_mapping.assert_called_once_with(
            lead_id, thread_id
        )

    def test_update_thread_id_invalid_lead_id(
        self, conversation_manager, mock_db_manager
    ):
    ...
    def test_update_thread_id_empty_thread_id(
        self, conversation_manager, mock_db_manager
    ):
    ...
    def test_update_thread_id_none_thread_id(
        self, conversation_manager, mock_db_manager
    ):
    ...
    def test_update_thread_id_database_error(
        self, conversation_manager, mock_db_manager
    ):
    ...
    def test_update_thread_id_nonexistent_lead(
        self, conversation_manager, mock_db_manager
    ):
    ...
    def test_update_thread_id_existing_mapping(
        self, conversation_manager, mock_db_manager
    ):
...
class TestGetNextQualificationStep:
    ...
    def test_get_next_qualification_step_initial(
        self, conversation_manager, mock_db_manager
    ):
    ...
    def test_get_next_qualification_step_after_greeting(
        self, conversation_manager, mock_db_manager
    ):
    ...
    def test_get_next_qualification_step_progression(
        self, conversation_manager, mock_db_manager
    ):
    ...
    def test_get_next_qualification_step_completed(
        self, conversation_manager, mock_db_manager
    ):
    ...
    def test_get_next_qualification_step_mixed_conversation(
        self, conversation_manager, mock_db_manager
    ):
    ...
    def test_get_next_qualification_step_no_metadata(
        self, conversation_manager, mock_db_manager
    ):
    ...
    def test_get_next_qualification_step_invalid_lead(
        self, conversation_manager, mock_db_manager
    ):
...
class TestConversationManagerEdgeCases:
    ...
    def test_large_conversation_history_handling(
        self, conversation_manager, mock_db_manager, sample_lead
    ):
