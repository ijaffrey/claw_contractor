...
class NotificationService:
    ...
    def send_contractor_notification(self, lead_data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            missing_fields = [
                field for field in required_fields if field not in lead_data
            ]
            if missing_fields:
    ...
    def send_customer_handoff_message(self, customer_data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            if missing_fields:
                self.logger.error(
                    f"Missing required fields for customer handoff: {missing_fields}"
                )
                self.log_notification(
            ...
            # Prepare email content
            subject = (
                f"Your {customer_data['service_type']} Service - Contractor Assignment"
            )
    ...
    def get_notification_stats(self, days: int = 30) -> Dict[str, Any]:
        ...
        try:
            log_file = os.path.join(
                os.path.dirname(__file__), "..", "logs", "notifications.jsonl"
            )
