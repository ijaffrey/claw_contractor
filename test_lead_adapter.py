...
def test_lead_adapter_structure():
    ...
    try:
        ...
        print(
            f"✓ lead_adapter structure validated - found {len(available_items)}/{len(expected_items)} expected items"
        )
        return True
...
if __name__ == "__main__":
    ...
    tests = [test_lead_adapter_import, test_lead_adapter_structure]
